...
export default class WebGPUHandler {
  ...
  private constructor() {
    ...
    try {
      ...
      throw new Error(
        `During initializing WebGPURenderingContext, unexpected error is occurred: ${err.message}`
      );
    }
 ...
 * @protected
 */
export const IS_WEBGPU_SUPPORTED =
  'WebGPURenderingContext' in window && 'WebGPUComputeCommandEncoder' in window;
